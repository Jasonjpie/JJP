  ...
  return (
    <div className="grid grid-cols-12 w-full bg-[#132026] text-white p-10">
        <div className="col-span-4 flex flex-col gap-10 w-full">
            ...
            <div className="text-6xl leading-tight font-bold">We always provide various <span className="text-primary">benefits</span> for you</div>
        ...
        <div className="col-span-8 grid grid-cols-3 gap-5 w-full items-center p-16">
            {

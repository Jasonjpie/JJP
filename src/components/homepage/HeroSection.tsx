        ...
        <div className="flex flex-wrap justify-around xl:items-center items-end gap-10 relative font-poppins p-3 lg:py-12 min-h-[100vh]">
          ...
          <div className="flex flex-col gap-10">
            <div className="animated fadeInDown p-3 bg-[#101C3D] rounded-xl bg-opacity-40 max-w-md text-white leading-loose font-montserrat">
              <div>
                Over 200 Homes Built in Los Angeles with Our Name on it! and We Carry that Proudly!
              </div>
              <div>
                Build Your Home with the JJP Team, get started today by booking your FREE consultation TODAY! 
              </div>
            </div>
            <div className="animated fadeInUp flex gap-3">
              ...
              <Link href='https://calendly.com/JasonPie' className="px-8 py-2 w-fit rounded-md text-white bg-[#101C3D]" target="_blank">
                Book Now
              </Link>
            </div>

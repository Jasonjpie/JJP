  ...
  return (
    <div className="w-full my-24 space-y-16">
        <div className="grid grid-cols-3">
            <div className="flex flex-col relative col-span-1 mx-auto">
            ...
            <div className='col-span-2 leading-loose font-montserrat text-gray-500 text-2xl max-w-[850px] p-3'>
        ...
        <div className="grid grid-cols-4 gap-10 h-[1100px] ">
            ...
            <div className="h-[80%] self-end">
                ...
                <div className="space-y-3 bg-[#222831] h-[30%]">
                    <div className="text-white font-bold font-playfair text-5xl leading-relaxed py-5 px-10">
                        Dellacorte House
                    </div>
